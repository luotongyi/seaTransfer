...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.navigation = [[[UINavigationController alloc] initWithRootViewController:index] autorelease];
    ...
    self.navigation.navigationBar.titleTextAttributes = dict;
    self.navigation.navigationBar.translucent = NO;
    self.navigation.navigationBar.tintColor = [UIColor whiteColor];
    if (isIOS7) {
        self.navigation.navigationBar.barTintColor = HEXCOLOR(0x176B8FF);
    } else {
        self.navigation.navigationBar.tintColor = HEXCOLOR(0x176B8FF);
    }
